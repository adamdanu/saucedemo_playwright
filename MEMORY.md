# Project Memory (Modular Index)

This project uses modular, topic-based memory for efficient token usage. Consult the index below and load only the relevant memory file on-demand.

| Topic | File | Scope |
|---|---|---|
| 🔐 **Authentication** | [.agents/memory/auth-quirks.md](.agents/memory/auth-quirks.md) | Logins, error banners, lockouts |
